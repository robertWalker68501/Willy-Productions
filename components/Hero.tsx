...
const Hero = () => {
  return (
    <section className='flex h-screen flex-col items-center justify-center bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/dot-pattern-redical.svg)] bg-cover bg-center text-sm text-slate-800'>
