...
const Hero = () => {
  return (
    <section className='mt-20 mb-40 flex pb-16 text-sm text-white md:mt-40 md:px-16 lg:px-24 xl:px-32'>
      <div className='flex w-full flex-col items-center justify-between gap-20 lg:flex-row'>
        <div className='max-md:px-4 lg:w-1/2'>
          <h1 className='max-w-lg text-5xl font-semibold text-slate-800 md:text-[54px] md:leading-[4.7rem] dark:text-white'>
