...
const Hero = () => {
  return (
    <section className='mt-20 mb-40 flex bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/dot-pattern-redical.svg)] bg-cover bg-center pb-16 text-sm text-slate-800 md:px-16 lg:px-24 xl:px-32'>
